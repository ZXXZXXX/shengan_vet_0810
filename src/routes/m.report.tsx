...
const diseaseKB_postpartum: DiseaseEntry[] = [
    ...
    plans: [
      {
        id: "p1",
        rx: "处方 1 · 检查处方",
        desc: "为期 14 天的产后检查任务，1 天 1 次记录直肠体温并采集牛只正前 / 正后照片",
        items: [
          C("直肠体温", "检查", "数字输入"),
          C("情况评估", "检查", "图片视频"),
        ],
  ...
  },
  {
    ...
    plans: [
      { id: "p1", rx: "处方 1 · 5% 头孢噻呋 + 氟尼辛", desc: "难产助产 3/4 分、双胎、死胎牛只，预防性用药预防生殖系统感染；产后 7 天体温异常者进一步体检确诊", items: [
      ...
      { id: "p2", rx: "处方 2 · 10% 头孢噻呋 + 氟尼辛", desc: "难产助产 3/4 分、双胎、死胎牛只，长效方案 3 天 1 次；产后 7 天体温异常者进一步体检确诊", items: [
