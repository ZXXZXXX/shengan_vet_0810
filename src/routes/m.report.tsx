...
// 修蹄工单（肢蹄病）—— 与 src/lib/wo-plan.ts 中处方模版严格对齐
// 药品行统一格式：`药名 剂量 · 给药方法（用药方法）`；理疗项写"操作 · 说明"
const diseaseKB_hoof: DiseaseEntry[] = [
  {
    name: "腐蹄病",
    symptoms: ["跛行", "腐蹄", "趾间糜烂", "蹄冠红肿", "蹄部脓肿"],
    plans: [
      {
        id: "p1",
        rx: "处方 1 · 修蹄清创 + 头孢噻呋 + 氟尼辛",
        desc: "清创后局部包扎，配合全身抗炎",
        drugs: [
          "修蹄清创 · 清除坏死组织并冲洗（单次）",
          "5% 盐酸头孢噻呋（畜可健） 4.4mL/100kg · 肌肉注射（1 天 1 次，连用 3 天）",
          "氟尼辛葡甲胺（福欣安） 4mL/100kg · 静脉推注（1 天 1 次，连用 3 天）",
        ],
        duration: "3 天",
      },
      {
        id: "p2",
        rx: "处方 2 · 修蹄清创 + 蹄浴",
        desc: "10% 硫酸铜蹄浴 + 防腐生肌散外敷",
        drugs: [
          "修蹄清创 · 清除坏死组织并冲洗（单次）",
          "10% 硫酸铜蹄浴液 · 浸没蹄部（隔日 1 次，共 3 次）",
          "防腐生肌散 · 蹄部外敷覆盖创面（1 天 1 次，连用 3 天）",
        ],
        duration: "3 天",
      },
    ],
    ...
    plans: [
      {
        ...
        drugs: [
          "修蹄清创 · 清除坏死组织并冲洗（单次）",
          "盐酸四环素喷剂 · 外用喷洒覆盖病灶（1 天 2 次，连用 3 天）",
        ],
        duration: "3 天",
      },
    ],
    ...
    plans: [
      {
        id: "p1",
        rx: "处方 1 · 修蹄清创 + 蹄块 + 抗炎",
        desc: "对侧健蹄粘蹄块减压，配合全身抗炎",
        drugs: [
          "修蹄清创 · 清除坏死组织并冲洗（单次）",
          "蹄块粘接剂（Demotec） 1 组/头 · 对侧健蹄粘接（单次处理，7 天复查）",
          "5% 盐酸头孢噻呋（畜可健） 4.4mL/100kg · 肌肉注射（1 天 1 次，连用 3 天）",
          "氟尼辛葡甲胺（福欣安） 4mL/100kg · 静脉推注（1 天 1 次，连用 3 天）",
        ],
        duration: "3 天",
  ...
  {
    name: "群体蹄浴",
    symptoms: ["群体轻度跛行", "预防性蹄浴", "趾间皮炎高发"],
    plans: [
      {
        id: "p1",
        rx: "处方 1 · 功能性蹄浴液喷蹄",
        desc: "10% 硫酸铜蹄浴，隔日 1 次共 3 次",
        drugs: [
          "10% 硫酸铜蹄浴液 · 浸没蹄部（隔日 1 次，共 3 次）",
        ],
        duration: "3 次（约 5 天）",
