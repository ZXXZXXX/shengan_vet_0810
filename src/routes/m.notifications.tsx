...
const MSGS: Msg[] = [
  // ===== 工单类：待执行的工单内任务、待诊断的工单 =====
  {
    id: "n1",
    cat: "workorder",
    title: "牛只 #01-24-2381 出现了发热、精神沉郁，请尽快完成诊断。",
  ...
  },
  {
    id: "n2",
    cat: "workorder",
    title: "牛只 #01-24-2412 需要执行体温复测，已逾期，请尽快处理。",
  ...
  },
  {
    id: "n3",
    cat: "workorder",
    title: "牛只 #01-24-2356 需要执行疾病治疗用药，已逾期，请尽快处理。",
    desc: "「兽医」王医生为您指派 #01-24-2356 的疾病治疗工作，计划今日 15:00 开始执行。",
    time: "2 小时前",
    ts: 120,
  ...
  // ===== 平台类：免疫工单下发、修蹄工单下发等 =====
  {
    ...
    cat: "platform",
    title: "免疫工单：口蹄疫春季加强",
    desc: "平台已批量下发免疫工单，包括 3 个牛舍，共计 128 头牛只，计划在本周内全部完成。",
    time: "30 分钟前",
    ts: 30,
    jump: { kind: "orderList" },
    unread: true,
  },
  {
    ...
    cat: "platform",
    title: "修蹄工单：周度例行修蹄",
    desc: "平台已批量下发修蹄工单，包括 1 个牛舍，共计 18 头牛只，计划在本周内全部完成。",
    time: "1 小时前",
    ts: 60,
    jump: { kind: "orderList" },
    unread: true,
  ...
  // ===== 基础检查类：平台下发的基础检查任务 =====
  {
    id: "e1",
    cat: "exam",
    title: "基础检查：牛只 #01-24-2381 产后例检",
    desc: "请对该牛只完成以下基础检查：体温测量、子宫分泌物评分、酮病血酮值检测。请在今日 18:00 前完成并在牛只档案中记录。",
    time: "8 分钟前",
    ts: 8,
    unread: true,
    jump: { kind: "cattle", earTag: "#01-24-2381" },
