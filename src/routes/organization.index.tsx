...
export const Route = createFileRoute("/organization/")({
  head: () => ({
    meta: [
      { title: "组织管理 — 奇点智牧" },
      { name: "description", content: "组织树与人员账号集中管理" },
    ],
  }),
...
type Farm = {
  ...
  staff: number;
  status: "启用" | "停用";
  people: { name: string; role: string; dept: string; phone: string; status: "在岗" | "请假" }[];
};
...
const farms: Farm[] = [
  {
    ...
    people: [
      ...
      { name: "陈思琪", role: "数据分析师", dept: "运维支持", phone: "186****4421", status: "请假" },
    ],
  },
  {
    id: "ORG-102",
    ...
    status: "启用",
    people: [
      { name: "高建波", role: "场长", dept: "兽医部", phone: "139****1102", status: "在岗" },
      { name: "孙明", role: "饲养主管", dept: "饲养部", phone: "135****1923", status: "在岗" },
      { name: "赵岩", role: "挤奶班长", dept: "挤奶车间", phone: "139****7710", status: "在岗" },
    ],
  },
  {
    id: "ORG-103",
    ...
    status: "启用",
    people: [
      { name: "周凯", role: "场长", dept: "管理处", phone: "135****8821", status: "在岗" },
      { name: "杨帆", role: "饲养主管", dept: "饲养部", phone: "186****6612", status: "在岗" },
    ],
  },
  {
    id: "ORG-104",
    ...
    status: "启用",
    people: [
      { name: "孙明", role: "场长", dept: "管理处", phone: "135****1923", status: "在岗" },
    ],
  },
];

function OrganizationPage() {
  const [selectedId, setSelectedId] = useState<string>(farms[0].id);
            ...
            <Card className="border-border bg-card overflow-hidden">
              <div className="flex items-center justify-between p-6 pb-4 flex-wrap gap-3">
                <div>
                  ...
                  <p className="text-caption text-text-tertiary mt-0.5">共 {farm.people.length} 人 · 在岗 {farm.people.filter((p) => p.status === "在岗").length} 人</p>
                </div>
                <div className="flex items-center gap-2">
