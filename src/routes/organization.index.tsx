...
const rows: OrgRow[] = [
  { code: "GRP-001", name: "奇点牧业集团", level: "集团（租户）", parent: "—", leader: "陈志远", people: 192, status: "启用" },
  ...
  { code: "ORG-103", name: "3 号牧场", level: "经营主体", parent: "奇点牧业集团", leader: "周凯", people: 28, status: "启用" },
  { code: "ORG-104", name: "西部育成基地", level: "经营主体", parent: "奇点牧业集团", leader: "孙明", people: 22, status: "启用" },
  { code: "ORG-105", name: "试验性饲养基地", level: "经营主体", parent: "奇点牧业集团", leader: "—", people: 0, status: "停用" },
];
