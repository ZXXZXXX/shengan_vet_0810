...
const tasks: Task[] = [
  ...
  { id: "HF-0702", target: "#A2150", barn: "2 号牛舍", kind: "疾病治疗", type: "疾病治疗", event: "右后蹄趾间皮炎", proposer: "周凯", who: "外部·张师傅", approver: "王主管", status: "进行中", createdAt: "今日 07:30", executedAt: "今日 07:30", scope: { type: "single", ear: "#A2150" }, conclusion: "右后蹄趾间皮炎", desc: "削蹄并贴蹄垫", needPickup: false },
  { id: "HF-0688", target: "#A2270", barn: "3 号牛舍", kind: "疾病治疗", type: "疾病治疗", event: "蹄底溃疡处理", proposer: "周凯", who: "外部·张师傅", approver: "王主管", status: "已完成", createdAt: "5 月 12 日", executedAt: "5 月 12 日 10:00", scope: { type: "single", ear: "#A2270" }, conclusion: "蹄底溃疡", desc: "削蹄并贴蹄垫", needPickup: false },
