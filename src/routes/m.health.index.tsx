...
const tasks: Task[] = [
  ...
  { id: "WO-2440", target: "#A2440", barn: "3 号牛舍", kind: "健康", type: "疾病治疗", event: "乳房炎 · 观察期满", proposer: "陈晓东", who: "李雨晴", visitor: "王主管", status: "进行中", createdAt: "2025-05-18", executedAt: "2025-05-20", reviewedAt: "2025-05-23", scope: { type: "single", ear: "#A2440" }, conclusion: "乳房炎 · 观察期满，待确认治愈", desc: "观察期内未发起复诊，请助理确认治愈并填写转栏信息", needPickup: false, symptoms: ["乳房红肿"] },
