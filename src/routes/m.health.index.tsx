...
const tasks: Task[] = [
  ...
  { id: "WO-2420", target: "#01-24-2420", barn: "3 号牛舍", kind: "健康", type: "疾病治疗", event: "乳房炎 · 待兽医复查", proposer: "陈晓东", who: "李雨晴", visitor: "王主管", status: "进行中", createdAt: "2025-05-26", executedAt: "2025-05-28", scope: { type: "single", ear: "#01-24-2420" }, conclusion: "乳房炎（处方已执行完成，待复查验收）", desc: "3 日抗炎方案已按计划完成，待兽医复查", needPickup: false, symptoms: ["乳房红肿"] },
  { id: "WO-2430", target: "#01-24-2430", barn: "3 号牛舍", kind: "健康", type: "疾病治疗", event: "乳房炎 · 继续观察中", proposer: "陈晓东", who: "李雨晴", visitor: "王主管", status: "进行中", createdAt: "2025-05-22", executedAt: "2025-05-24", reviewedAt: "2025-05-27", scope: { type: "single", ear: "#01-24-2430" }, conclusion: "乳房炎复查 → 继续观察 5 天", desc: "复查后兽医判定继续观察，期间如有异常可发起复诊", needPickup: false, symptoms: ["乳房红肿"] },
  { id: "WO-2440", target: "#01-24-2440", barn: "3 号牛舍", kind: "健康", type: "疾病治疗", event: "乳房炎 · 观察期满复查", proposer: "陈晓东", who: "李雨晴", visitor: "王主管", status: "进行中", createdAt: "2025-05-18", executedAt: "2025-05-20", reviewedAt: "2025-05-23", scope: { type: "single", ear: "#01-24-2440" }, conclusion: "乳房炎 · 观察期满，自动生成复查任务", desc: "观察期满后系统自动生成复查任务，由兽医执行复查", needPickup: false, symptoms: ["乳房红肿"] },
  ...
  { id: "HF-0702", target: "#01-24-2150", barn: "2 号牛舍", kind: "修蹄", type: "修蹄", event: "右后蹄趾间皮炎", proposer: "周凯", who: "外部·张师傅", visitor: "王主管", status: "进行中", createdAt: "2025-05-28", executedAt: "2025-05-28", scope: { type: "single", ear: "#01-24-2150" }, conclusion: "右后蹄趾间皮炎", desc: "削蹄并贴蹄垫", needPickup: false },
  { id: "HF-0688", target: "#01-24-2270", barn: "3 号牛舍", kind: "修蹄", type: "修蹄", event: "蹄底溃疡处理", proposer: "周凯", who: "外部·张师傅", visitor: "王主管", status: "已完成", createdAt: "2025-05-12", executedAt: "2025-05-12", scope: { type: "single", ear: "#01-24-2270" }, conclusion: "蹄底溃疡", desc: "削蹄并贴蹄垫", needPickup: false },
...
function TaskListPage() {
  ...
  if (role === "vet" || role === "manager") list = list.filter((t) => t.type === "疾病治疗");
