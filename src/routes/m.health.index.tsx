...
const tasks: Task[] = [
  ...
  // === 干奶工单 · 乳注处方 ===
  { id: "GN-0208", target: "#01-24-2208", barn: "干奶舍", kind: "健康", type: "干奶", event: "干奶 · 处方 1 牧全欣", proposer: "平台下发", who: "李雨晴", visitor: "—", status: "进行中", createdAt: "2026-05-28", executedAt: "2026-05-28", scope: { type: "single", ear: "#01-24-2208" }, conclusion: "常规干奶", desc: "硫酸头孢喹肟乳房注入剂（牧全欣）3g/支，按非盲乳数一次量乳注", needPickup: true },
  ...
  { id: "GN-0233", target: "#01-24-2233", barn: "干奶舍", kind: "健康", type: "干奶", event: "干奶 · 处方 5 赛福魁", proposer: "平台下发", who: "李雨晴", visitor: "—", status: "进行中", createdAt: "2026-05-26", executedAt: "2026-05-27", scope: { type: "single", ear: "#01-24-2233" }, conclusion: "常规干奶", desc: "硫酸头孢喹肟乳房注入剂（赛福魁）3g/支，按非盲乳数一次量乳注", needPickup: true },
