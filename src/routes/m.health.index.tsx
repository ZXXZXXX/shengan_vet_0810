...
const tasks: Task[] = [
  ...
  { id: "WO-2410", target: "#A2410", barn: "3 号牛舍", kind: "健康", type: "疾病治疗", event: "乳房炎复诊（复发）", proposer: "李雨晴", who: "李雨晴", visitor: "王主管", status: "待诊断", createdAt: "2025-05-29", reportedAt: "2025-05-29", scope: { type: "single", ear: "#A2410" }, conclusion: "复诊 · 乳房炎疑似复发", desc: "停药 5 天后乳区再次红肿，关联原始工单 WO-2150", needPickup: true, symptoms: ["乳房红肿", "体温升高"] },
  ...
  { id: "WO-2420", target: "#A2420", barn: "3 号牛舍", kind: "健康", type: "疾病治疗", event: "乳房炎 · 待兽医复查", proposer: "陈晓东", who: "李雨晴", visitor: "王主管", status: "进行中", createdAt: "2025-05-26", executedAt: "2025-05-28", scope: { type: "single", ear: "#A2420" }, conclusion: "乳房炎（处方已执行完成，待复查验收）", desc: "3 日抗炎方案已按计划完成，待兽医复查", needPickup: false, symptoms: ["乳房红肿"] },
  { id: "WO-2430", target: "#A2430", barn: "3 号牛舍", kind: "健康", type: "疾病治疗", event: "乳房炎 · 继续观察中", proposer: "陈晓东", who: "李雨晴", visitor: "王主管", status: "进行中", createdAt: "2025-05-22", executedAt: "2025-05-24", reviewedAt: "2025-05-27", scope: { type: "single", ear: "#A2430" }, conclusion: "乳房炎复查 → 继续观察 5 天", desc: "复查后兽医判定继续观察，期间如有异常可发起复诊", needPickup: false, symptoms: ["乳房红肿"] },
  { id: "WO-2440", target: "#A2440", barn: "3 号牛舍", kind: "健康", type: "疾病治疗", event: "乳房炎 · 观察期满复查", proposer: "陈晓东", who: "李雨晴", visitor: "王主管", status: "进行中", createdAt: "2025-05-18", executedAt: "2025-05-20", reviewedAt: "2025-05-23", scope: { type: "single", ear: "#A2440" }, conclusion: "乳房炎 · 观察期满，自动生成复查任务", desc: "观察期满后系统自动生成复查任务，由兽医执行复查", needPickup: false, symptoms: ["乳房红肿"] },
  { id: "WO-2199", target: "#A2199", barn: "3 号牛舍", kind: "健康", type: "疾病治疗", event: "乳房炎 · 复查超时自动归档", proposer: "陈晓东", who: "李雨晴", visitor: "王主管", status: "已完成", createdAt: "2025-05-08", executedAt: "2025-05-10", reviewedAt: "2025-05-13", scope: { type: "single", ear: "#A2199" }, conclusion: "乳房炎 · 复查任务 48 小时内未操作，系统自动归档", desc: "复查任务自动触发后 48 小时无人执行，系统自动标记为「逾期未完成」并归档工单", needPickup: false, symptoms: ["乳房红肿"] },
