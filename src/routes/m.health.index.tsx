...
const tasks: Task[] = [
  { id: "WO-2381", target: "#01-24-2381", barn: "3 号牛舍", kind: "健康", type: "疾病治疗", event: "持续高烧 2 小时", proposer: "陈晓东", who: "李雨晴", visitor: "王主管", status: "待诊断", createdAt: "2025-05-28", reportedAt: "2025-05-28", scope: { type: "single", ear: "#01-24-2381" }, conclusion: "疑似乳房炎急性发作", desc: "持续高烧 2 小时，需复查体温与乳样", needPickup: true, symptoms: ["体温升高", "采食下降", "反刍减少"] },
  { id: "WO-2410", target: "#01-24-2410", barn: "3 号牛舍", kind: "健康", type: "疾病治疗", event: "乳房炎复诊（复发）", proposer: "李雨晴", who: "李雨晴", visitor: "王主管", status: "待诊断", createdAt: "2025-05-29", reportedAt: "2025-05-29", scope: { type: "single", ear: "#01-24-2410" }, conclusion: "复诊 · 乳房炎疑似复发", desc: "停药 5 天后乳区再次红肿，关联原始工单 WO-2150", needPickup: true, symptoms: ["乳房红肿", "体温升高"] },
  { id: "WO-2298", target: "#01-24-2298", barn: "3 号牛舍", kind: "健康", type: "疾病治疗", event: "乳房炎复诊", proposer: "李雨晴", who: "李雨晴", visitor: "王主管", status: "进行中", createdAt: "2025-05-28", executedAt: "2025-05-28", scope: { type: "single", ear: "#01-24-2298" }, conclusion: "乳房炎复诊", desc: "复查体温与乳样", needPickup: true, symptoms: ["乳房红肿"] },
  { id: "WO-2420", target: "#01-24-2420", barn: "3 号牛舍", kind: "健康", type: "疾病治疗", event: "乳房炎 · 待兽医复查", proposer: "陈晓东", who: "李雨晴", visitor: "王主管", status: "进行中", createdAt: "2025-05-26", executedAt: "2025-05-28", scope: { type: "single", ear: "#01-24-2420" }, conclusion: "乳房炎（处方已执行完成，待复查验收）", desc: "3日抗炎处方已执行完成，待兽医复查", needPickup: false, symptoms: ["乳房红肿"] },
  
  { id: "WO-2440", target: "#01-24-2440", barn: "3 号牛舍", kind: "健康", type: "疾病治疗", event: "乳房炎 · 待兽医复查", proposer: "陈晓东", who: "李雨晴", visitor: "王主管", status: "进行中", createdAt: "2025-05-18", executedAt: "2025-05-20", reviewedAt: "2025-05-23", scope: { type: "single", ear: "#01-24-2440" }, conclusion: "乳房炎（处方已执行完成，待复查验收）", desc: "5日抗炎处方已执行完成，待兽医复查", needPickup: false, symptoms: ["乳房红肿"] },
  { id: "WO-2199", target: "#01-24-2199", barn: "3 号牛舍", kind: "健康", type: "疾病治疗", event: "乳房炎 · 复查超时自动归档", proposer: "陈晓东", who: "李雨晴", visitor: "王主管", status: "已完成", createdAt: "2025-05-08", executedAt: "2025-05-10", reviewedAt: "2025-05-13", scope: { type: "single", ear: "#01-24-2199" }, conclusion: "乳房炎 · 复查任务 48 小时内未操作，系统自动归档", desc: "复查任务自动触发后 48 小时无人执行，系统自动标记为「逾期未完成」并归档工单", needPickup: false, symptoms: ["乳房红肿"] },
  ...
  { id: "PP-2501", target: "#01-24-2710", barn: "产房 1 号", kind: "健康", type: "产后护理", event: "产后用药护理（平台下发）", proposer: "平台下发", who: "周凯", visitor: "—", status: "进行中", createdAt: "2025-05-28", executedAt: "2025-05-28", scope: { type: "single", ear: "#01-24-2710" }, conclusion: "产后用药护理", desc: "高危新产牛体检与用药", needPickup: true, symptoms: [] },
  { id: "PP-2502", target: "#01-24-2725", barn: "产房 2 号", kind: "健康", type: "产后护理", event: "产后例行检查（平台下发）", proposer: "平台下发", who: "周凯", visitor: "—", status: "进行中", createdAt: "2025-05-28", executedAt: "2025-05-28", scope: { type: "single", ear: "#01-24-2725" }, conclusion: "产后检查记录", desc: "新产牛产后第 5 天例行体检", needPickup: false, symptoms: [] },
  ...
  { id: "HF-0702", target: "#01-24-2150", barn: "2 号牛舍", kind: "修蹄", type: "修蹄", event: "右后蹄趾间皮炎", proposer: "周凯", who: "外部·张师傅", visitor: "王主管", status: "进行中", createdAt: "2025-05-28", executedAt: "2025-05-28", scope: { type: "single", ear: "#01-24-2150" }, conclusion: "右后蹄趾间皮炎", desc: "削蹄并贴蹄垫", needPickup: true },
  { id: "HF-0688", target: "#01-24-2270", barn: "3 号牛舍", kind: "修蹄", type: "修蹄", event: "蹄底溃疡处理", proposer: "周凯", who: "外部·张师傅", visitor: "王主管", status: "已完成", createdAt: "2025-05-12", executedAt: "2025-05-12", scope: { type: "single", ear: "#01-24-2270" }, conclusion: "蹄底溃疡", desc: "削蹄并贴蹄垫", needPickup: true },
