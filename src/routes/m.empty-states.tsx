...
const scenarios: Scenario[] = [
  ...
  {
    title: "现场上报",
    desc: "现场人员提交健康线索，生成待出诊工单，由 PC 端完成诊疗确认与派单。",
    tags: ["现场线索", "PC 出诊"],
    results: [
  ...
  {
    title: "工单详情",
    desc: "展示工单从上报、出诊到执行的完整信息，便于现场人员理解任务要求。",
    tags: ["流程追踪", "只读/执行"],
    results: [
      "详情页需区分上报记录、出诊记录、执行记录。",
      "非执行人进入时只展示查看态，不展示执行按钮。",
      "已完成、已驳回、已终止状态需展示结果与原因。",
    ],
    empties: [
      { label: "暂无出诊记录", hint: "PC 端出诊后会同步展示。" },
