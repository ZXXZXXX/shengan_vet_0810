                ...
                return (
                  <div key={f.id} className="select-none">
                    ...
                    <div className="group relative flex items-center gap-1 px-2 py-2 hover:bg-[var(--sidebar-hover,var(--bg-surface-subtle))]">
                      ...
                      <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity rounded-md bg-[var(--sidebar-hover,var(--bg-surface-subtle))] px-2 py-0.5 shadow-sm before:content-[''] before:absolute before:-left-4 before:top-0 before:bottom-0 before:w-4 before:bg-gradient-to-r before:from-transparent before:to-[var(--sidebar-hover,var(--bg-surface-subtle))] before:pointer-events-none">
                        <IconBtn
                          title="新增牛舍"
                          onClick={() => {
