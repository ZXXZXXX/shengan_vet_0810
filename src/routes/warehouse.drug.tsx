      ...
      <main className="flex-1 px-6 py-6 space-y-4 bg-white">
        ...
        <Card className="border-border bg-card overflow-hidden">
          ...
          {filtered.map((d) => (
            ...
            >
              <div className="grid grid-cols-[120px_minmax(0,1.6fr)_minmax(0,1fr)_80px_100px_100px_100px] gap-4 flex-1 min-w-0">
                ...
                <div className="truncate">
                  <span className="tag tag-muted">{d.drugType}</span>
                </div>
