...
const pendingItems: Array<{
  ...
  { id: "HF-0702", title: "右后蹄趾间皮炎疾病治疗", barn: "2 号牛舍", time: "已逾期 4h", bucket: "已逾期", tagClass: "tag-danger", icon: TimerReset, watermark: Footprints, tone: "danger", farmId: "f1" },
  { id: "HF-0815", title: "蹄底溃疡疾病治疗", barn: "3 号牛舍", time: "今日 10:20", bucket: "待响应", tagClass: "tag-warning", icon: TimerReset, watermark: Footprints, tone: "warning", farmId: "f2" },
